@if ($errors->any())
    ...
    <div class="bs-toast toast fade show bg-danger toast-placement-ex m-5 top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
            ...
            {{-- <small>11 mins ago</small> --}}            <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
        </div>
...
@if (Session::has('warning'))
    ...
    <div class="bs-toast toast fade show bg-warning toast-placement-ex m-5 top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
            <i class="bx bx-bell me-2"></i>
