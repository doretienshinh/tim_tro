                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Tên người yêu cầu rời</label>
                                    <input class="form-control" type="text" id="html5-time-input" value="{{ $Hostel_user->user->name }}" readonly/>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Email người yêu cầu rời</label>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-md-12">
                                    <select id="status" class="selectpicker w-100" data-style="btn-default" name="status">
                                        <option value="accept_leave">Chấp nhận</option>
                                        <option value="eject_leave">Từ chối</option>
                                    </select>
                                </div>
                            </div>
                            <div class="mt-2">
