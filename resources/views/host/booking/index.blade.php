...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Bookings Tables</h4>

    <div class="card">
        <div class="card-header d-flex align-items-center navbar">
            <h5>Bookings Tables</h5>
            {{-- <button type="button" onclick="window.location=''" class="btn btn-icon btn-primary">
