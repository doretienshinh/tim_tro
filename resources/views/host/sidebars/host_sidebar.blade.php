<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('home') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">TimTro</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ (strpos(Route::currentRouteName(), 'host.hostel.index') === 0) ? 'active' : '' }}">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('host.hostel.index') }}" class="menu-link">
                        <div data-i18n="Without menu">Danh sách bài đăng</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('host.hostel.create') }}" class="menu-link">
        ...
        <li class="menu-item {{ (strpos(Route::currentRouteName(), 'host.time.index') === 0) ? 'active' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class='bx bx-time-five tf-icons menu-icon'></i>
                <div data-i18n="Layouts">Thời gian</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('host.time.index') }}" class="menu-link">
                        <div data-i18n="Without menu">Danh sách thời gian</div>
                    </a>
                </li>
                <li class="menu-item">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('host.user.detail') }}" class="menu-link">
