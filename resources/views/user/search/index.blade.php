    ...
    <div class="card-header border-bottom p-1">
        ...
        <div class="d-flex justify-content-between align-items-center row py-3 gap-3 gap-md-0">
            <div class="col-md-3 user_role">
                <select id="priceRange" class="form-select text-capitalize">
                    <option value="0" selected> Tất cả</option>
                    <option value="2000">1tr -> 2tr</option>
                    <option value="3000">2tr -> 3tr</option>
                    <option value="4000">3tr -> 4tr</option>
                    <option value="5000">4tr -> 5tr</option>
                    <option value="6000">5tr -> 6tr</option>
                    <option value="7000">6tr -> 7tr</option>
                    <option value="higher">Trên 7tr</option>
                </select>
            </div>
            <div class="col-md-3 user_plan">
                <select id="tag" class="form-select text-capitalize">
