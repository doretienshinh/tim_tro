...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center navbar">
            <h5>Times Tables</h5>
            <button type="button" onclick="window.location='{{ URL::route('host.time.create'); }}'" class="btn btn-icon btn-primary">
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('host.time.edit', $time) }}"><i class="bx bx-edit-alt me-1"></i>
                                        Edit</a>
