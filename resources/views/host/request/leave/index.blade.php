...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Danh sách /</span> yêu cầu rời trọ</h4>
        ...
        <div class="table-responsive text-nowrap" style="overflow-x: inherit;">
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    @if ($requestHostel->status == 'request_leave' || $requestHostel->status == 'eject_leave')
                        <tr>
                            ...
                            <td>{{ $requestHostel->status == 'request_leave' ? 'Đang yêu cầu' : 'Từ chối' }}</td>
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('host.request.edit_leave', $requestHostel->id) }}"><i class="bx bx-edit-alt me-1"></i>
                                            Edit</a>
