                ...
                t.exports = function() {
                        ...
                        position(t) {
                            ...
                            if ("manual" != e.position) {
                                ...
                                this.state.dropdown.visible) {
                                    if ("text" == u ? (a = (i = this.getCaretGlobalPosition()).bottom,
                                    s = i.top,
                                    n = i.left,
                                    o = "auto") : (r = function(t) {
                        ...
                        callbacks: {
                                    ...
                                    "mix" == e.mode) {
                                        ...
                                        case "Backspace":
                                            ...
                                            if ("BR" == r.anchorNode.nodeName)
                                                return;
                                            if ((d || g) && 1 == r.anchorNode.nodeType ? a = 0 == r.anchorOffset ? d ? c[0] : null : c[Math.min(c.length, r.anchorOffset) - 1] : d ? a = r.anchorNode.nextElementSibling : g && (a = g),
                            ...
                            onEditTagBlur(t) {
                                ...
                                this.DOM.scope.contains(t)) {
                                    var e, i, s = this.settings, a = t.closest("." + s.classNames.tag), n = this.input.normalize.call(this, t), o = this.tagData(a), r = o.__originalData, l = this.editTagChangeDetected(o), d = this.validateTag({
                                        [s.tagTextProp]: n,
                                        __tagId: o.__tagId
                                    });
                                    if (n)
                            ...
                            onDoubleClickScope(t) {
                                var e, i, s = t.target.closest("." + this.settings.classNames.tag), a = this.tagData(s), n = this.settings;
                            ...
                            onInputDOMChange(t) {
                                t.forEach((t=>{
                                    t.addedNodes.forEach((t=>{
                                        ...
                                        } else if (v.call(this, t) && (3 != t.previousSibling?.nodeType || t.previousSibling.textContent || t.previousSibling.remove(),
                    ...
                    return M.prototype = {
                        ...
                        applySettings(t, i) {
                            ...
                            if (s.disabled = t.hasAttribute("disabled"),
                        ...
                        onEditTagDone(t, e) {
                            ...
                            this.settings.a11y.focusableTags ? t.focus() : this.placeCaretAfterNode(t)) : t && this.removeTags(t),
                        ...
                        injectAtCaret(t, e) {
                            ...
                            this) : ("string" == typeof t && (t = document.createTextNode(t)),
                            e.deleteContents(),
                            e.insertNode(t),
