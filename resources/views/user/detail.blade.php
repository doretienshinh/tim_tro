                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            ...
                            <img src="{{ asset('storage/' . $user->avatar) }}" alt="user-avatar" class="d-block rounded"
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-2">
                            <button type="reset" onclick="window.location='{{ URL::route('admin.user.edit', $user->id) }}'" class="btn btn-primary me-2">Sửa</button>
