...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tag Edit</span></h4>

        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <form id="formAccountSettings" method="POST" action=" {{ route('admin.tag.update', $tag) }}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="html5-time-input" name="name" value="{{ $tag->name }}"/>
                                    @if ($errors->has('name'))
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="html5-time-input" name="description" value="{{ $tag->description }}"/>
